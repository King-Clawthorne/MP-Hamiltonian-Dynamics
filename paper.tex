...
The implementation and raw results are \href{experiment.py}{\nolinkurl{experiment.py}},
\href{results/precision_sweep.csv}{\nolinkurl{results/precision_sweep.csv}},
\href{results/stochastic_sweep.csv}{\nolinkurl{results/stochastic_sweep.csv}}, and
\href{results/duration_sweep.csv}{\nolinkurl{results/duration_sweep.csv}}. Model
fits are saved in \href{results/crossover_fit.json}{\nolinkurl{results/crossover_fit.json}}
and \href{results/duration_scaling.json}{\nolinkurl{results/duration_scaling.json}}.
Fixed-coefficient duration predictions are in
\href{results/fixed_b_duration_predictions.csv}{\nolinkurl{results/fixed_b_duration_predictions.csv}}.
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.82\linewidth]{results/precision_crossover.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.82\linewidth]{results/stochastic_error_curves.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.82\linewidth]{results/precision_scaling.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.82\linewidth]{results/duration_scaling.png}
